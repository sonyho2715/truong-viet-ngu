...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-brand-cream">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-brand-navy to-brand-navy/90 py-20 text-white">
        <div className="absolute inset-0 bg-[url('/images/pattern.png')] opacity-5" />
        <div className="container relative mx-auto px-4">
          <Breadcrumb items={[{ label: 'Giới Thiệu' }]} />
          <div className="mx-auto max-w-3xl text-center">
            <Church className="mx-auto mb-6 h-20 w-20 text-brand-gold" />
            <h1 className="font-serif text-4xl font-bold md:text-5xl">
              Trường Việt Ngữ
            </h1>
            <p className="mt-2 text-2xl text-brand-gold">Thiếu Nhi Thánh Thể</p>
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h2 className="mb-12 text-center font-serif text-3xl font-bold text-brand-navy">
            Giá Trị Cốt Lõi
          </h2>
          <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-2 lg:grid-cols-4">
            {values.map((value, index) => (
              <div
                key={index}
                className="rounded-xl border-2 border-brand-gold/20 bg-gradient-to-b from-brand-gold/5 to-transparent p-6 text-center transition-all hover:border-brand-gold hover:shadow-lg"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-5xl">
            <div className="mb-12 text-center">
              <Cross className="mx-auto mb-4 h-12 w-12 text-brand-gold" />
            ...
            {/* Introduction */}
            <div className="mb-12 rounded-2xl bg-gradient-to-r from-brand-navy to-brand-navy/90 p-8 text-white md:p-12">
              <p className="text-lg leading-relaxed">
                ...
                đó, <strong className="text-brand-gold">117 vị</strong> đã được
                Đức Giáo Hoàng Gioan Phaolô II tuyên phong Hiển Thánh vào ngày{' '}
                <strong className="text-brand-gold">19 tháng 6 năm 1988</strong>.
              </p>
              <div className="mt-6 grid gap-4 text-center md:grid-cols-3">
                ...
                <div className="rounded-lg bg-white/10 p-4">
                  <div className="text-3xl font-bold text-brand-gold">59</div>
            ...
            {/* Featured Martyrs */}
            <h3 className="mb-6 text-center font-serif text-2xl font-bold text-brand-navy">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {martyrsInfo.map((martyr, index) => (
                ...
                >
                  <div className="bg-brand-gold/10 p-4">
            ...
            {/* Timeline */}
            <div className="mt-16">
              <h3 className="mb-8 text-center font-serif text-2xl font-bold text-brand-navy">
                ...
                <div className="space-y-8">
                  {timelineEvents.map((event, index) => (
                    ...
                    >
                      <div className="flex-1 md:text-right">
                        {index % 2 === 0 && (
                          <div className="rounded-xl bg-white p-6 shadow-sm">
                            <div className="mb-2 text-2xl font-bold text-brand-gold">
                              {event.year}
                            </div>
                            <h4 className="font-serif text-lg font-bold text-brand-navy">
                              {event.title}
                      ...
                      <div className="relative z-10 hidden h-4 w-4 rounded-full bg-brand-gold md:block" />
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl">
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-4">
              <div className="rounded-xl bg-brand-navy p-6 text-center text-white">
                <div className="text-4xl font-bold text-brand-gold">15+</div>
                <div className="mt-2 text-sm">Năm hoạt động</div>
              </div>
              <div className="rounded-xl bg-brand-navy p-6 text-center text-white">
                <div className="text-4xl font-bold text-brand-gold">8</div>
