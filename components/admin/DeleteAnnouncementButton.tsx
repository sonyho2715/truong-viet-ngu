  ...
  return (
    <div className="relative">
      <button
        ...
        title={showConfirm ? 'Nhấn lần nữa để xác nhận xóa' : 'Xóa'}
      >
        {isPending ? (
          <svg
      ...
      {showConfirm && !isPending && (
        <>
          ...
          <div className="absolute right-0 top-full z-50 mt-2 w-64 rounded-lg border border-red-200 bg-white p-4 shadow-xl">
            <p className="text-sm font-medium text-gray-900">Xóa thông báo?</p>
            <p className="mt-1 text-xs text-gray-600">
              Bạn có chắc muốn xóa thông báo <strong>{title}</strong>?
            </p>
